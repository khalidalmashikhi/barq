...
// t.providerServiceStatusAll ("All Statuses") and
...
export function ProviderAvailabilityFilters({ currentSearch, currentState }: ProviderAvailabilityFiltersProps) {
  return (
    <form method="get" className="flex flex-col gap-4 rounded-2xl border border-border bg-card p-5 shadow-sm">
      <div className="flex items-center gap-2 rounded-full border border-border bg-background px-4 py-2.5">
        ...
        <input
          ...
          placeholder={t.providerAvailabilitySearchPlaceholder}
