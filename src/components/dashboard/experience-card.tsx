  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="absolute start-3 top-3 rounded-full bg-white/90 px-3 py-1 text-xs font-medium text-primary backdrop-blur-sm">
          {category}
        </span>
        ...
        <button
          ...
          className="absolute end-3 top-3 flex h-8 w-8 items-center justify-center rounded-full bg-white/90 text-foreground/60 backdrop-blur-sm transition-colors hover:text-danger"
        >
