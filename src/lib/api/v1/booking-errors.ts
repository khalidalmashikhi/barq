...
const CODE_MAP: Record<BookingActionErrorCode, ApiErrorCode> = {
  ...
  // EXCLUSIVE ACCOUNT TYPES (Gate Z-2) — an effective PROVIDER hitting the customer
  // booking-create endpoint. A genuine authorization refusal, so FORBIDDEN.
  PROVIDER_CANNOT_BOOK: "FORBIDDEN",
